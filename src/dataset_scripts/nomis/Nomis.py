...
def Employment_Conversion():
    ...
    ''' 
        ...
        HOW TO GENERATE LINK MANUALLY:
            To get Percentage Column -- 
            Geography: local authorities: district / unitary (as of April 2023)
            Date: Dec 2024
            Variable: Employment rate - aged 16-64

            To get number Column -- 
            Geography: local authorities: district / unitary (as of April 2023)
            Date: Dec 2024
            Variable: Economically active - In employment 2 (On user defined -> Not Supplied (63062))
    '''
    ...
    '''
        URLS Below are for 2015 local districts
